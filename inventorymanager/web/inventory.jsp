...
<%@taglib prefix="sql" uri="http://java.sun.com/jsp/jstl/sql"%>
        <% 
            ...
            String sql = ("UPDATE mapmyindia SET Approved = ? WHERE Part = ? AND Product = ? AND Uses = ? AND TIME = ? LIMIT 1");
...
FAULTY-->
 <% 
            ...
            ResultSet resultset = statement.executeQuery("select * from mapmyindia Where Approved ='Approved' ") ;
