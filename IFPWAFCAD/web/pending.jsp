...
<%
            ...
            ResultSet resultset = statement.executeQuery("select * from Map_My_India Where Approved ='Pending' ") ; 
        ...
        <TABLE BORDER="1">
            ...
            <TR>
                <form action="pendingcalc.jsp" method="POST">
                    ...
                    <TD><input type="text" name="approve" value=" <%= resultset.getString(7) %>"  /></TD>
                    <TD><input type="text" name="time" value=" <%= resultset.getString(9) %>"  /></TD>
